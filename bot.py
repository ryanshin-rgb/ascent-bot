...
AGENTS = {
    "schedule": {
        "keywords": ["일정", "스케줄", "미팅", "캘린더", "약속", "행사", "촬영"],
        "prompt": "당신은 어센트스포츠 스케줄 전담 에이전트입니다. 한국어로만, 짧고 핵심만, 마크다운 기호 절대 사용 금지."
    },
    "finance": {
        "keywords": ["정산", "재무", "비용", "청구", "VAT", "세금", "수익", "매출", "지출"],
        "prompt": "당신은 어센트스포츠 재무/정산 전담 에이전트입니다. 한국어로만, 짧고 핵심만, 마크다운 기호 절대 사용 금지."
    },
    "sales": {
        "keywords": ["견적", "영업", "제안서", "계약", "클라이언트", "수주"],
        "prompt": "당신은 어센트스포츠 영업/견적 전담 에이전트입니다. 한국어로만, 짧고 핵심만, 마크다운 기호 절대 사용 금지."
    },
    "marketing": {
        "keywords": ["마케팅", "캠페인", "광고", "콘텐츠", "SNS", "바이메이더"],
        "prompt": "당신은 어센트스포츠 마케팅 전담 에이전트입니다. 한국어로만, 짧고 핵심만, 마크다운 기호 절대 사용 금지."
    },
    "ambassador": {
        "keywords": ["이강인", "앰버서더", "선수", "매니지먼트", "얼티밋"],
        "prompt": "당신은 어센트스포츠 앰버서더 전담 에이전트입니다. 한국어로만, 짧고 핵심만, 마크다운 기호 절대 사용 금지."
    },
    "ir": {
        "keywords": ["투자", "IR", "투자자", "Series", "펀딩", "해외"],
        "prompt": "당신은 어센트스포츠 IR/해외 전담 에이전트입니다. 한국어로만, 짧고 핵심만, 마크다운 기호 절대 사용 금지."
    }
}
